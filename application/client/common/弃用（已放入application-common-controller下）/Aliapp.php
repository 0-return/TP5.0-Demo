...
class Aliapp extends Alipay
{
     ...
     *date:2018/05/30
     */
    public function alipay_trade_refund($data)
    {
        $this->obj = new AlipayController();
    ...
    {
        $params = array(
            'sys_service_provider_id' => $data['sys_service_provider_id'],        //系统商编号
            'hb_fq_num' => $data['hb_fq_num'],      //分期数
            'hb_fq_seller_percent' => $data['hb_fq_seller_percent'],   //代表卖家承担收费比例，商家承担手续费传入100，用户承担手续费传入0，仅支持传入100、0两种，其他比例暂不支持，传入会报错。
        );
