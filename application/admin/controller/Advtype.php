...
class Advtype extends Init{

    function _initialize()
    {
        parent::_init();
        $this->table = $this->config['prefix'].'advtype';
    }
     ...
     public function _before_add(&$list)
    {
        ...
        if ($this->request->post()){
            ...
            $option = cate_tree_html($this->obj, $this->table, array('pid' => 'aid', 'id' => 'id', 'title' => 'title', 'status' => 'status'));
