...
class SmsDemo
{
     ...
     * @return stdClass
     */
    public static function sendSms($phoneNumbers,$templateCode,$templateParam,$outId) {
        ...
        $request->setSignName(self::$title);
     ...
     * @return stdClass
     */
    public static function sendBatchSms($phoneNumbers,$templateCode,$templateParam,$outId) {
        ...
        $request->setSignNameJson(json_encode(self::$title, JSON_UNESCAPED_UNICODE));
     ...
     * @return stdClass
     */
    public static function querySendDetails($phoneNumber,$sendDate,$outId) {
